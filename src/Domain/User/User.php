 ...
 * 
 * Diese Klasse ist Teil der Domain-Schicht und dient als zentrales 
 * Datentransferobjekt (DTO) zwischen der Persistenzschicht (Infrastructure), 
 * der Geschäftslogik (Application) und der Session-Speicherung.
 * Sie ist bewusst anämisch gehalten (enthält primär Daten, wenig Logik),
 * um Serialisierung und Transport über Schichtengrenzen hinweg zu erleichtern.
 */
class User
{
    /**
     ...
     * @param int    $authVersion  Die Version der Authentifizierungsdaten (Anti-Replay Token).
     */
     ...
     * Dient zur Erkennung von veralteten Sessions (Anti-Replay).
     * @return int
     */
